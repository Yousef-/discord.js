...
//TODO: make a cool down 

//when the bot receives a message
bot.on("message", function (msg) {
    //TODO: add !help and !info
    if (msg.author == bot.user) { //ignore messages from self
    }
    else {
...
function command(msg, code) {
    ...
    //TODO: make it so ti doesnt read too much
    ...
    //servers commands
    {
        ...
        if (code == 1) {
            //fun shit (pics)
            {
                if (message.includes("!peeves") == true) {
                    bot.sendFile(msg.channel, "C:/Users/Yousef/Google Drive/botfiles/peeves/peeves" + Math.floor((Math.random() * 6) + 1) + ".png", "peeves.png")
                }
                if (message.includes("!yumi") == true) {
                    bot.sendFile(msg.channel, "C:/Users/Yousef/Google Drive/botfiles/yumi.png", "yumi.png")
                }
            }
        }
        ...
        if (code == 3) {
            ...
            if (message.includes("!boku") == true) {
                bot.sendFile(msg.channel, "C:/Users/Yousef/Google Drive/botfiles/!boku.png", "!boku.png");
            }
